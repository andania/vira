...
export enum RateLimitTier {
  PUBLIC = 'public', // 10 requests per minute
  AUTHENTICATED = 'authenticated', // 100 requests per minute
  SPONSOR = 'sponsor', // 500 requests per minute
  ADMIN = 'admin', // 1000 requests per minute
